...
export default function AgentNamePie() {
    ...
    return (
        <>
            ...
            {
                chartData.agent_name.length <= 0 ? <div className="w-full bg-white rounded shadow-md flex justify-center items-center flex-col"><p className=' text-2xl font-bold'>場域設備</p> <p>未連接任何外部設備</p></div> : <PieGraph title="場域設備數量" data={chartData.agent_name} />
            }
        </>
    )
}